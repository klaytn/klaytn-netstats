...
History.prototype.add = function(block, id, trusted, addingHistory)
{
	...
	// Klaytn has no uncle blocks.
	if( !_.isUndefined(block) && !_.isUndefined(block.number) && !_.isUndefined(block.transactions) && !_.isUndefined(block.difficulty) && block.number > 0 )
	{
