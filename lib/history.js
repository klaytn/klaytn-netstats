...
// History.prototype.getBaseFee = function()
// {
// 	var baseFee = _( this._items )
// 		.sortByOrder( 'height', false )
// 		// .filter(function (item)
// 		// {
// 		// 	return item.block.trusted;
...
// 		.map(function (item)
// 		{
// 			return item.block.baseFeePerGas;
// 		})
// 		.value();
...
History.prototype.getCharts = function()
{
	if(this._callback !== null)
	{
		var chartHistory = _( this._items )
			...
			.map(function (item)
			{
				...
				return {
					...
					baseFee: parseInt(item.block.baseFeePerGas, 16) / 1000000000,
				};
			})
			.value();
		...
		this._callback(null, {
			...
			baseFee: _.pluck( chartHistory, 'baseFee' ),
